...
public class DayBillSummary extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bill_day=in.getStringExtra("date_rep");
        ...
        Cursor c_count= data.rawQuery("select * from "+Database.BD_TABLE_NAME+" where "+Database.BD_DATE+" = "+bill_day,null);
        ...
        for(c1.moveToFirst();!c1.isAfterLast();c1.moveToNext()) {
            if (c1.getString(1).equals(bill_day)) {
                break;
        ...
        String col2[]=new String[]{Database.BI_BILL_NO,Database.BI_BILL_TOTAL,Database.BI_AMT_PAID,Database.BI_AMT_PENDING,Database.BI_PAYMENT_STATUS,Database.BI_BILL_DATE};
        Cursor c2=mydb.query(Database.BI_TABLE_NAME, col2, null, null, null, null, null);
        for(c2.moveToFirst();!c2.isAfterLast();c2.moveToNext()){
            if(c2.getString(5).equals(bill_day)){
                break;
            }
        }
        ...
        for(c.moveToFirst();!c.isAfterLast();c.moveToNext()){
            if(c.getString(8).equals(bill_day)){
