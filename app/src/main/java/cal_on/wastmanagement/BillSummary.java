...
public class BillSummary extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       ///bill_t=in.getStringExtra("bill_total");
        ...
        Cursor c_count= data.rawQuery("select * from "+Database.BD_TABLE_NAME+" where "+Database.BD_BILL_NO+" = "+bill_no,null);
        ...
        String col2[]=new String[]{Database.BI_BILL_NO,Database.BI_BILL_TOTAL,Database.BI_AMT_PAID,Database.BI_AMT_PENDING,Database.BI_PAYMENT_STATUS};
      ...
      String col[]=new String[]{Database.BD_PARTICULARS,Database.BD_LABOUR_CHARGES,Database.BD_ITEM_ID,Database.BD_ITEM_TOTAL,Database.BD_BILL_NO,Database.BD_GOLD_WT,Database.BD_NAME,Database.BD_SILVER_WT,Database.BD_DATE,Database.BD_BILL_NO};
        ...
        for(c.moveToFirst();!c.isAfterLast();c.moveToNext()){
            if(c.getString(4).equals(bill_no)){
