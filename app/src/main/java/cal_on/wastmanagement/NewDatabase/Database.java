...
public class Database {
	public static final String CAl_DATABASE_NAME = "CAL";
	public static final int CAL_DATABASE_VERSION = 1;
	...
	public static final String BI_Cust_TABLE_NAME = "CUST_TABLE";

	public static final String BI_Cust_BILL_NO = "Cust_no";//Auto Increment

	public static final String BI_Item_TABLE_NAME = "ITEM_TABLE";

	public static final String BI_Item_BILL_NO = "item_no";//Auto Increment
