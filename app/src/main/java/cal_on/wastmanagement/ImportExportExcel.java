...
public class ImportExportExcel {
	...
	protected static final File DATABASE_DIRECTORY = new File(Environment.getExternalStorageDirectory(), "ImportExport");

	protected static final File IMPORT_ITEM_FILE = new File(DATABASE_DIRECTORY,"kittuabcdef.csv");
