...
import cal_on.wastmanagement.R;

public class BillSummaryAdapter extends Activity {
	// Declare Variables
	TextView txtrank;
	TextView txtcountry;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bill_details_inflate);
