...
public class CustomerAdapter  extends BaseAdapter {
    ...
    private List<WorldCustomer> worldpopulationlist = null;
    private ArrayList<WorldCustomer> arraylist;

    public CustomerAdapter(Context context, List<WorldCustomer> worldpopulationlist) {
        mContext = context;
        this.worldpopulationlist = worldpopulationlist;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<WorldCustomer>();
    ...
    @Override
    public WorldCustomer getItem(int position) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.customertransactions_inflate, null);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(mContext, CustomerSummaryAdapter.class);
    ...
    public void filter(String charText) {
        ...
        {
            for (WorldCustomer wp : arraylist)
            {
